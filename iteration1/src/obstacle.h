 ...
 * collisions.
 *
 * Obstacles move and upon any collisions reverse in an arc determined
...
class Obstacle : public ArenaMobileEntity {
 public:
  ...
  /**
   * @brief Update the Obstacles's position and velocity after the specified
   * duration has passed.
   *
