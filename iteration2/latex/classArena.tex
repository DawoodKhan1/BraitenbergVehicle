...
\item 
void {\bfseries Add\+Entity} (\hyperlink{entity__type_8h_ad79a57ed3105eb60d991a1aeb4a9dc44}{Entity\+Type} type, int quantity)\hypertarget{classArena_a9e00ef1a079d49d648359952fcfaa9f3}{}\label{classArena_a9e00ef1a079d49d648359952fcfaa9f3}

\item 
void \hyperlink{classArena_a16fac8e4b2399fcf0db01a9722069c33}{Accept\+Command} (\hyperlink{communication_8h_a836c27e2d64d0efa4a526150bdf6f3e5}{Communication} com)
\item 
...
std\+::vector$<$ class \hyperlink{classRobot}{Robot} $\ast$ $>$ \hyperlink{classArena_a8deeb917467907421cc5eca257c4d59d}{get\+\_\+robots} () const 
\begin{DoxyCompactList}\small\item\em Get the Robots in \hyperlink{classArena}{Arena}. \end{DoxyCompactList}\item 
...
void \hyperlink{classArena_ab6d6ba8d4765fc495d82b67eac497c02}{check\+Robot\+Collide\+Food} (\hyperlink{classRobot}{Robot} $\ast$robot, \hyperlink{classArenaEntity}{Arena\+Entity} $\ast$food)\hypertarget{classArena_ab6d6ba8d4765fc495d82b67eac497c02}{}\label{classArena_ab6d6ba8d4765fc495d82b67eac497c02}

\begin{DoxyCompactList}\small\item\em Checks if a robot is within 5 pixels of a food entity object Then sets robot\textquotesingle{}s flags accordingly. \end{DoxyCompactList}\item 
...
\hyperlink{entity__type_8h_ad79a57ed3105eb60d991a1aeb4a9dc44}{Entity\+Type} \hyperlink{classArena_a7b72cf7688ee6ab1395bf438663bc1da}{Get\+Collision\+Wall} (\hyperlink{classArenaMobileEntity}{Arena\+Mobile\+Entity} $\ast$const ent)
...
void \hyperlink{classArena_a51c1e99dfd9a618c6041fd22d0a11959}{Adjust\+Wall\+Overlap} (\hyperlink{classArenaMobileEntity}{Arena\+Mobile\+Entity} $\ast$const ent, \hyperlink{entity__type_8h_ad79a57ed3105eb60d991a1aeb4a9dc44}{Entity\+Type} wall)\hypertarget{classArena_a51c1e99dfd9a618c6041fd22d0a11959}{}\label{classArena_a51c1e99dfd9a618c6041fd22d0a11959}
...
The arena sends information about the location of various objects to the robot\textquotesingle{}s sensors. 
...
\hline
\end{DoxyParams}
Also records time in time\+\_\+ private member.

If {\ttfamily dt == 0}, {\ttfamily return} immediately. Otherwise calls \hyperlink{classArena_a682ec81cb30e36e5bb801b3388bcb494}{Arena\+::\+Update\+Entities\+Timestep()} once. \index{Arena@{Arena}!get\+\_\+robots@{get\+\_\+robots}}
\index{get\+\_\+robots@{get\+\_\+robots}!Arena@{Arena}}
\subsubsection[{\texorpdfstring{get\+\_\+robots() const }{get_robots() const }}]{\setlength{\rightskip}{0pt plus 5cm}std\+::vector$<$class {\bf Robot} $\ast$$>$ Arena\+::get\+\_\+robots (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classArena_a8deeb917467907421cc5eca257c4d59d}{}\label{classArena_a8deeb917467907421cc5eca257c4d59d}


Get the Robots in \hyperlink{classArena}{Arena}. 

\begin{DoxyReturn}{Returns}
A vector of pointers to the Robots. 
\end{DoxyReturn}
\index{Arena@{Arena}!Get\+Collision\+Wall@{Get\+Collision\+Wall}}
\index{Get\+Collision\+Wall@{Get\+Collision\+Wall}!Arena@{Arena}}
\subsubsection[{\texorpdfstring{Get\+Collision\+Wall(\+Arena\+Mobile\+Entity $\ast$const ent)}{GetCollisionWall(ArenaMobileEntity *const ent)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Entity\+Type} Arena\+::\+Get\+Collision\+Wall (
\begin{DoxyParamCaption}
...
First calls each entity\textquotesingle{}s Timestep\+Update method to update their speed, heading angle, and position. Then check for collisions between entities or between an entity and a wall. This function also checks for win/loss conditions. Also passes the time\+\_\+ to the robot by getting current time in robot and adding the current time so it could calculate invincibility. 
