...
While the window is open Update\+Simulation will be called repeatedly, once per frame. It does not advance time if the game is paused.

Draw\+Robot changes the appearence of the robot depending on the hunger level. Also displays 2 white light sensors. 
...
\hline
\end{DoxyParams}
\index{Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}!Is\+Paused@{Is\+Paused}}
\index{Is\+Paused@{Is\+Paused}!Graphics\+Arena\+Viewer@{Graphics\+Arena\+Viewer}}
\subsubsection[{\texorpdfstring{Is\+Paused() const }{IsPaused() const }}]{\setlength{\rightskip}{0pt plus 5cm}bool Graphics\+Arena\+Viewer\+::\+Is\+Paused (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classGraphicsArenaViewer_abec101b321264e48735dd4b5e07a4948}{}\label{classGraphicsArenaViewer_abec101b321264e48735dd4b5e07a4948}


Getter for paused, which is the pause/playing state of simulation. 
