...
class Sensor {
  ...
  */
  ...
  double get_numerator_value() { return numerator_value_; }
  void set_numerator_value(int numeratorValue) {
    numerator_value_ = numeratorValue; }
 ...
 protected:
  ...
  int numerator_value_{1200};  // default value in equation
};
